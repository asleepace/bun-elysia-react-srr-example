...
var require_runtime = __commonJS((exports, module) => {
  var react_refresh_runtime_development = __toESM(require_react_refresh_runtime_development(), 1);
  if (false) {
  } else {
...
function App() {
  ...
  return import_react.default.createElement("html", null, import_react.default.createElement("head", null, import_react.default.createElement("meta", {
    ...
    rel: "stylesheet",
    href: "./public/assets/styles.css"
  })), import_react.default.createElement("body", null, import_react.default.createElement("div", {
    id: "root"
  }, import_react.default.createElement("h1", null, "Counter ", count), import_react.default.createElement("button", {
...
var reactRoot = client.hydrateRoot(document, import_react2.default.createElement(App, null));
var socket = new WebSocket(`ws://localhost:3000/hmr`);
socket.addEventListener("message", ({ data }) => {
  console.log("[client] on message:", data);
  runtime.default.performReactRefresh();
});
